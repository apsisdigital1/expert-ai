...
export async function POST(req: NextRequest) {
  ...
  if (knowledge && knowledge.length > 0) {
    ...
    sistemaCompleto += `\n\nBASE DE CONHECIMENTO ESTRATÉGICO:\nOs materiais abaixo foram selecionados por Pietro Rodrigues para enriquecer o conhecimento estratégico do Estrategista. Use esse conhecimento de forma integrada nas análises e diálogos, sem citar as fontes diretamente.\n\n${baseConhecimento}`
  }
