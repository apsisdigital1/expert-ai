...
export default function Posicionamento() {
  ...
  async function processarPDF() {
    ...
    reader.onload = async (e) => {
      ...
      setMensagens([{
        role: 'assistant',
        content: 'Recebi seu documento. Deixa eu analisar o que você já tem construído sobre identidade, imagem, autenticidade e comunicação e identificar o que ainda precisa ser desenvolvido.'
      }])
      try {
        const res = await fetch('/api/posicionamento-pdf', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          ...
          <div style={{ maxWidth: '600px', width: '100%' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
              <div onClick={iniciarChat} style={{ background: 'rgba(255,255,255,0.02)', border: '0.5px solid rgba(255,255,255,0.08)', borderRadius: '12px', padding: '28px', cursor: 'pointer' }}
                ...
                <div style={{ fontSize: '13px', color: 'rgba(255,255,255,0.35)', lineHeight: '1.5' }}>A IA conduz você por identidade, imagem, autenticidade e comunicação e entrega o Canvas do Expert completo.</div>
              ...
              <div onClick={() => setModo('upload')} style={{ background: 'rgba(255,255,255,0.02)', border: '0.5px solid rgba(255,255,255,0.08)', borderRadius: '12px', padding: '28px', cursor: 'pointer' }}
                ...
                <div style={{ fontSize: '13px', color: 'rgba(255,255,255,0.35)', lineHeight: '1.5' }}>Suba um PDF com o que você já tem e a IA completa e aprofunda o que estiver faltando.</div>
        ...
        <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px' }}>
          <div style={{ maxWidth: '500px', width: '100%' }}>
            <div style={{ marginBottom: '32px' }}>
              ...
              <div style={{ fontSize: '13px', color: 'rgba(255,255,255,0.35)', lineHeight: '1.5' }}>Pode ser o DOC 1 de Identidade, DOC 2 de Imagem, DOC 3 de Comunicação ou qualquer material sobre seu posicionamento.</div>
            </div>
