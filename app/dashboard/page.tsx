...
const ferramentas = [
  { num: '01', nome: 'Entrevista de Diagnóstico', desc: 'A IA faz uma análise completa de quem você é, como é percebido e o que precisa construir antes de qualquer estratégia.', slug: 'diagnostico' },
  { num: '02', nome: 'Posicionamento', desc: 'Identidade, imagem, autenticidade e comunicação construídos juntos. Entrega o Canvas do Expert completo.', slug: 'posicionamento' },
  { num: '03', nome: 'Audiência e Comunidade', desc: 'ICP, Persona, universo de marca, identidade da tribo e Canvas da Comunidade completo.', slug: 'comunidade' },
  { num: '04', nome: 'Narrativa Visceral', desc: 'A verdade que só você tem coragem de nomear transformada em narrativa que vende antes de qualquer oferta.', slug: 'narrativa' },
  { num: '05', nome: 'Máquina de Conteúdo', desc: '30 dias de conteúdo estratégico gerado com base na sua narrativa, suas premissas e seu ICP.', slug: 'conteudo' },
  { num: '06', nome: 'Ecossistema de Produtos', desc: 'Produto bestseller definido, esteira completa e jornada de ascensão do cliente mapeada.', slug: 'produtos' },
]
    ...
    <div style={{ minHeight: '100vh', background: '#07090F', display: 'flex', fontFamily: 'system-ui, sans-serif' }}>
      ...
      <div style={{ flex: 1, padding: '32px', overflowY: 'auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '20px' }}>
          {ferramentas.map((f) => (
            <div key={f.slug} onClick={() => router.push(`/${f.slug}`)} style={{ background: 'rgba(255,255,255,0.02)', border: '0.5px solid rgba(255,255,255,0.06)', borderRadius: '10px', padding: '20px', cursor: 'pointer' }}
